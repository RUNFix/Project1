...
import SocialMediaIcons from './SocialMediaCards';
    ...
    <>
      <div className="flex flex-col min-h-screen bg-gray-50 text-justify">
        ...
        <main className="flex-grow container mx-auto p-4 mt-16 ">
          ...
          {/* CARDS */}
          <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 m-auto mb-4">
            <Card
              title={
          ...
          <section className="flex flex-col items-center my-24">
            ...
            <p className="text-justify text-xl w-3/4">
              ...
              somos su aliado estratégico en el cuidado de su vehículo. Nos
              diferenciamos al adoptar un enfoque de servicio completo que va
              más allá de la simple reparación y mantenimiento. Utilizamos la
              tecnología para mejorar la transparencia, agilizar la comunicación
              y optimizar todas las etapas del servicio.
            </p>
          ...
          <section className="m-8 bg-slate-50 border-8 border-indigo-400 p-12 rounded-3xl">
